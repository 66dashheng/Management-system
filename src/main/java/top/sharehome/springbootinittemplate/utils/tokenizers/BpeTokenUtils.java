 ...
 * 💡源自GPT2
 * BPE（字节对编码）算法（https://github.com/openai/gpt-2/blob/master/src/encoder.py）
 *
 * @author AntonyCheng
 */
@Slf4j
    ...
    private static String bpe(String token) {
        ...
        while (true) {
            ...
            while (i < word.size()) {
                ...
                i = j;
                if (Objects.equals(word.get(i), first) && i < word.size() - 1
                        && Objects.equals(word.get(i + 1), second)) {
