...
public class FileServiceImpl extends ServiceImpl<FileMapper, File> implements FileService {
    ...
    public Page<AdminFilePageVo> adminPageFile(AdminFilePageDto adminFilePageDto, PageModel pageModel) {
        ...
        fileLambdaQueryWrapper
                ...
                .eq(StringUtils.isNotBlank(adminFilePageDto.getOssType()), File::getOssType,
                        adminFilePageDto.getOssType())
                .like(StringUtils.isNotBlank(adminFilePageDto.getOriginalName()), File::getOriginalName,
                        adminFilePageDto.getOriginalName());
        // 构造查询排序（默认按照创建时间降序排序）
